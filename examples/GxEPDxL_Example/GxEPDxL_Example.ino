// GxEPDxL_Example : test example for HD e-Paper displays from Dalian Good Display Inc. (parallel interface).
//
...
void showBitmapExample()
{
  ...
  delay(5000);
  display.fillScreen(GxEPD_WHITE);
  display.drawBitmap(bwBitmap640x384_2, (GxEPD_WIDTH - 640) / 2, (GxEPD_HEIGHT - 384) / 2, 640, 384, GxEPD_BLACK, GxEPDxL::bm_flip_y);
  display.update();
  delay(10000);
#endif
}
