...
#ifndef _GxGDE043A2xL_H
#define _GxGDE043A2xL_H

#include <Arduino.h>
#include "GxEPDxL.h"
#include "GxDESTM32L_IO.h"

#define GxGDE043A2xL_WIDTH 800
#define GxGDE043A2xL_HEIGHT 600
#define GxGDE043A2xL_BUFFER_SIZE GxGDE043A2xL_WIDTH * GxGDE043A2xL_HEIGHT / 4 // 2bits per pixel
#define GxGDE043A2xL_CL_DELAY 13 // this value produces the same CL period as the hex demo code

#define GxGDE043A2xL_FRAME_BEGIN_SIZE 18
const unsigned char wave_begin_43[4][GxGDE043A2xL_FRAME_BEGIN_SIZE] =
{
...
#define GxGDE043A2xL_FRAME_END_SIZE 26
const unsigned char wave_end_43[4][GxGDE043A2xL_FRAME_END_SIZE] =
{
...
#define GxGDE043A2xL_ROW_BUFFER_SIZE (GxGDE043A2xL_WIDTH / 4)

// fixed, multiple of 64 and >= GxGDE043A2xL_ROW_BUFFER_SIZE
#define WAVE_TABLE_SIZE 256

typedef uint8_t epd_buffer_type[GxGDE043A2xL_BUFFER_SIZE];
...
class GxGDE043A2xL : public GxEPDxL
{
  public:
    GxGDE043A2xL(GxDESTM32L_IO& io);
  ...
  private:
    ...
    void clear_display();
  private:
    uint8_t wave_begin_table[WAVE_TABLE_SIZE][GxGDE043A2xL_FRAME_BEGIN_SIZE];
    uint8_t wave_end_table[WAVE_TABLE_SIZE][GxGDE043A2xL_FRAME_END_SIZE];
    uint8_t row_buffer[GxGDE043A2xL_ROW_BUFFER_SIZE];
    epd_buffer_type* p_active_buffer;
    epd_buffer_type* p_erase_buffer;
    GxDESTM32L_IO& IO;
};

#define GxEPD_Class GxGDE043A2xL

#define GxEPD_WIDTH GxGDE043A2xL_WIDTH
#define GxEPD_HEIGHT GxGDE043A2xL_HEIGHT
