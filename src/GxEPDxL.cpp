// class GxEPDxL : Base Class for Display Classes for e-Paper Displays from Dalian Good Display Co., Ltd.: www.good-display.com
//
...
//
// Library: https://github.com/ZinggJM/GxEPDxL
...
void  GxEPDxL::drawBitmapBM(const uint8_t *bitmap, uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t color, int16_t mode)
{
