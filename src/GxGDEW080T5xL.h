...
#ifndef _GxGDEW080T5xL_H_
#define _GxGDEW080T5xL_H_

#include <Arduino.h>
#include "GxEPDxL.h"
#include "GxDESTM32L_IO.h"

#define GxGDEW080T5xL_WIDTH 1024
#define GxGDEW080T5xL_HEIGHT 768
#define GxGDEW080T5xL_BUFFER_SIZE GxGDEW080T5xL_WIDTH * GxGDEW080T5xL_HEIGHT / 4 // 2bits per pixel
#define GxGDEW080T5xL_CL_DELAY 13 // this value produces the same CL period as the hex demo code

#define GxGDEW080T5xL_FRAME_BEGIN_SIZE  8
const unsigned char wave_begin_80[4][GxGDEW080T5xL_FRAME_BEGIN_SIZE] =
{
...
#define GxGDEW080T5xL_FRAME_END_SIZE  18
const unsigned char wave_end_80[4][GxGDEW080T5xL_FRAME_END_SIZE] =
{
...
#define GxGDEW080T5xL_ROW_BUFFER_SIZE (GxGDEW080T5xL_WIDTH / 4)

// fixed, multiple of 64 and >= GxGDEW080T5xL_ROW_BUFFER_SIZE
#define WAVE_TABLE_SIZE 256

typedef uint8_t epd_buffer_type[GxGDEW080T5xL_BUFFER_SIZE];
...
class GxGDEW080T5xL : public GxEPDxL
{
  public:
    GxGDEW080T5xL(GxDESTM32L_IO& io);
  ...
  private:
    ...
    void clear_display();
  private:
    uint8_t wave_begin_table[WAVE_TABLE_SIZE][GxGDEW080T5xL_FRAME_BEGIN_SIZE];
    uint8_t wave_end_table[WAVE_TABLE_SIZE][GxGDEW080T5xL_FRAME_END_SIZE];
    uint8_t row_buffer[GxGDEW080T5xL_ROW_BUFFER_SIZE];
    epd_buffer_type* p_active_buffer;
    epd_buffer_type* p_erase_buffer;
    GxDESTM32L_IO& IO;
};

#define GxEPD_Class GxGDEW080T5xL

#define GxEPD_WIDTH GxGDEW080T5xL_WIDTH
#define GxEPD_HEIGHT GxGDEW080T5xL_HEIGHT
#define GxEPD_BitmapExamples <examples/BitmapExamples1024x768.h>
#define GxEPD_BitmapExamplesQ "examples/BitmapExamples1024x768.h"
#define BitmapExample1 BitmapExample1024x768_1
#define BitmapExample2 BitmapExample1024x768_2
